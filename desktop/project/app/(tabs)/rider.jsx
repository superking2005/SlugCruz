...
export default function RidesScreen() {
  ...
  const [filteredDriverRides, setFilteredDriverRides] = useState([]);
  ...
  const fetchDriverRides = async () => {
    ...
    if (error) {
      ...
      console.log('Fetched driver rides:', JSON.stringify(data, null, 2));
      setDriverRides(data);
    }
  };
  ...
  return (
    <View style={styles.fullScreenContainer}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {/* Filter section for driver rides */}
        <Text style={styles.header}>Filter Available Rides from Drivers</Text>
        ...
        {/* Show filtered driver rides if filters are applied */}
        {filteredDriverRides.length > 0 && (
          <>
            <Text style={styles.header}>Filtered Driver Rides</Text>
            <FlatList
              scrollEnabled={false}
                ...
                return (
                  <View style={styles.rideCard}>
                    ...
                    <Text style={styles.driverName}>
                      Driver: {item.profiles?.full_name || 'No name available'}
                    </Text>
        ...
        <Text style={styles.header}>All Available Rides from Drivers</Text>
